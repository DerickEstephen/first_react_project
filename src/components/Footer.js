...
function Footer() {
  return (
    <footer className="text-gray-300 bg-[#35363a]">
        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <Link className="hover:text-gray-200">First Link</Link>
              </li>
              <li>
                <Link className="hover:text-gray-200">Second Link</Link>
              </li>
              <li>
                <Link className="hover:text-gray-200">Third Link</Link>
              </li>
              <li>
                <Link className="hover:text-gray-200">Fourth Link</Link>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                <label for="footer-field" className="leading-7 text-sm">
                  Placeholder
                </label>
                <input
                  type="text"
      ...
      <div className="bg-gradient-to-t from-purple-500 via-indigo-500 to-blue-500">
        <div className="container py-6 text-white flex items-center sm:flex-row flex-col">
          <Link href="{{ route('index') }}" className="font-extrabold text-3xl">
